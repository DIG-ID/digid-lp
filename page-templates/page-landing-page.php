	...
	<div class="row">
		<div class="box-wrapper col-6 d-flex justify-content-center align-items-stretch h-100 min-vh-100 animate__animated animate__fadeInLeft">
			<div class="box-content d-flex flex-column justify-content-between">
				...
				<div class="content">
					<h1 class="">Ooops!... our website is under construction.</h1>
					<p class="">We are a growing company and we are improving our website. Meanwhile please feel free to contact us.</p>
					<a href="#" class="btn d-inline-block animate__animated animate__flipInX animate__delay-2s">Contact us now</a>
				</div>
				<ul class="contacts">
					<li>
					...
					<li>
						...
						<a href="tel:+41612222494">+41 61 222 24 94</a>
					</li>
					<li>
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M168.3 499.2C116.1 435 0 279.4 0 192C0 85.96 85.96 0 192 0C298 0 384 85.96 384 192C384 279.4 267 435 215.7 499.2C203.4 514.5 180.6 514.5 168.3 499.2H168.3zM192 256C227.3 256 256 227.3 256 192C256 156.7 227.3 128 192 128C156.7 128 128 156.7 128 192C128 227.3 156.7 256 192 256z"/></svg>
						<p>Grellingerstrasse 35,<br>4052<br>Basel (CH)</p>
					</li>
				</ul>
